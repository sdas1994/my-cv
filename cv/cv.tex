...
\name{Subhajoy}{Das}
\tagline{Senior Software Engineer | Data Architect }
\socialinfo{
	\linkedin{subhajoy-das}\\
	\smartphone{+91 8697167050}
	\email{subhajoydas94@gmail.com}
}

% Uncomment the following line and use a value from 1.5cm to 2.5cm
\setleftcolumnlength{2.3cm}
